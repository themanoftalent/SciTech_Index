...
* Upward arrows, downward arrows are used to indicate pitch changes;
* Round brackets with text inside are used to indicate a specific meaning of a polyseme;
* Square brackets with text inside are used to indicate gender and plural form of a word;
* Curly brackets with text inside are used to indicate the text escaped from other punctuation rules;
* Question marks are used to indicate unverified entries
